...
export default function Sidebar() {
  ...
  const NAV_ITEMS = [
    ...
    { to: "/ordenes-trabajo", label: "OTs", Icon: IconClipboard, show: esComercial || esTecnico || esSupervisor || esPlanner || esJefatura },
    { to: "/cotizaciones", label: "Cotizaciones", Icon: IconDocument, show: esComercial || esPlanner || esJefatura },
    { to: "/ordenes-compra", label: "Órdenes de Compra", Icon: IconCart, show: esComercial || esJefatura },
    ...
    { to: "/catalogo-servicios", label: "Catálogo", Icon: IconTag, show: esComercial || esJefatura },
    { to: "/almacen", label: "Almacén", Icon: IconArchive, show: esAdmin || esAlmacenero || esAsistente || esJefatura },
